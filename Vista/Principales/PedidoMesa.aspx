<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Maestra.master" CodeBehind="PedidoMesa.aspx.cs" Inherits="TechRestaurant.PedidoMesa" %>
    ...
    <div class ="col-6 offset-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class ="col-12">
                        <asp:Button type="submit" id="btAsignar" class="btn btn-success btn-block" OnClick="btAsignar_Click" runat="server" Text="Asignar Pedido" />
                    </div>               
                </div>

                <div class="form-group">
                    <div class ="col-12">
                        <asp:Button type="submit" id="btLiberar" class="btn btn-danger btn-block" OnClick="btLiberar_Click" runat="server" Text="Liberar Mesa" />
                    </div>               
                </div>
