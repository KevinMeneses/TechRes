<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Maestra.master" CodeBehind="ModificarEmpleado.aspx.cs" Inherits="TechRestaurant.ModificarEmpleado" %>
...
<asp:Content ContentPlaceHolderID ="contenido" runat="server">
    <div class ="col-4 offset-4">
        <div class="card">
            <div class="card-header bg-info text-white" style="text-align:center">MODIFICAR EMPLEADO</div>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class ="col-12">
                        <asp:Button type="submit" id="btGuardar" class="btn btn-info btn-lg btn-block" runat="server" OnClick="btGuardar_Click" Text="Guardar" />
                    </div>               
                </div>
