<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Maestra.master" CodeBehind="ModificarPedido.aspx.cs" Inherits="TechRestaurant.ModificarPedido" %>
...
<asp:Content ContentPlaceHolderID ="contenido" runat="server">
                <div class ="col-6 offset-3">
                    <div class="card">
                        <div class="card-header bg-info text-white" style="text-align:center">MODIFICAR PEDIDO</div>
